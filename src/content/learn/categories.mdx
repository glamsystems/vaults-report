...
<div className="not-prose text-xs text-muted-foreground italic leading-relaxed">
    Disclosure: This resource is published by GLAM. GLAM may appear in the Infrastructure examples below. Examples are illustrative and do not constitute endorsements. Evaluate all protocols independently.
</div>
